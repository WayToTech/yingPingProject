 ...
 */
public class UnCompleteFragment extends BaseFragment implements PullToRefreshRecyclerView.PullToRefreshRecyclerViewListener, CommentDataSource.CommentCallBack {
    ...
    public void onDownRefresh() {
        remoteRepo.requestTaskData("task/appTaskNotEndList", this);
    }
